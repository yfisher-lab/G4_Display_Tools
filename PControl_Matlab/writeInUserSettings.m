...
function_path = fullfile(root_path, 'write-in functions'); 
aofunction_path = fullfile(root_path, 'write-in ao_functions\');
pattern_path =  fullfile(root_path, 'Patterns');   
default_exp_path = fullfile(root_path, 'Write-In Experiment');
